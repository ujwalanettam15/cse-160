...
class Vector3 {
    ...
    /**
      ...
      */
     /* 
    implement  the functions add, sub, div and mul of the Vector3 class.
     */
    add(other) {
    ...
    static cross(other1, other2) {
        ...
        let element_1 = other1.elements;
        let element_2 = other2.elements;
        let v3 = new Vector3(); // Modify this line to calculate cross product between other1 and other2.
        
        v3.elements[0] = element_1[1] * element_2[2] - element_1[2] * element_2[1];
        v3.elements[1] = element_1[2] * element_2[0] - element_1[0] * element_2[2];
        v3.elements[2] = element_1[0] * element_2[1] - element_1[1] * element_2[0];
        // Don't delete the return statement.
        return v3;
    }
    ...
    magnitude() {
        // Insert your code here.
        let hold_e = this.elements;
        let m = Math.sqrt(hold_e[0] * hold_e[0] + hold_e[1] * hold_e[1] + hold_e[2] * hold_e[2]); // Modify this line to calculate this vector's magnitude.
        // Don't delete the return statement.
        return m;
    };
    ...
    normalize() {
        ...
        //if (this.magnitude() > 0) {
          //print(this.elements[0] /= this.magnitude());
          //this.elements[0] /= this.magnitude();
          //console.log(this.elements[0]);
          //print(this.elements[1] /= this.magnitude());
         // this.elements[1] /= this.magnitude(); 
          //console.log(this.elements[1]);
          //print(this.elements[2] /= this.magnitude());
         // this.elements[2] /= this.magnitude();
          //console.log(this.elements[2]);
          var magnitidue = this.magnitude();
          for (let i = 0; i < 3; i++) {
            this.elements[i]= this.elements[i] / magnitidue;
        }
        // Don't delete the return statement.
        return this;
    }
